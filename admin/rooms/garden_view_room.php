    ...
    <head>
        ...
        <?php
            ...
            if($_POST['room'])
            {
                ...
                $result = mysqli_query($con,"UPDATE garden_view_room SET fn=NULL,ln=NULL,gender=NULL,pno=NULL,email=NULL,address=NULL,pin=NULL,adults=NULL,children=NULL,price=NULL WHERE rno='$room';");
                mysqli_close($con);
    ...
    <body>
        <table>
            ...
            <tr>
                <th>
                <?php
                    $qry="SELECT * FROM garden_view_room";
                    include '../../database.php';
                    mysqli_select_db($con,"PROJECT");
                ...
                <th style="padding-left: 220px;">
                    ...
                    <?php
                        $qry="SELECT rno FROM garden_view_room WHERE fn IS NOT NULL";
                        $lcv=0;
                        include '../../database.php';
                        mysqli_select_db($con,"PROJECT");
                        $result = mysqli_query($con,$qry);
